...
# Compile the model
# model.compile(optimizer=tf.keras.optimizers.AdamW(learning_rate=0.001), loss='cosine_similarity', metrics=['accuracy'])  # Specify the loss function and optimizer
model.compile(optimizer=tf.keras.optimizers.AdamW(learning_rate=0.001), loss=custom_loss(distance_matrix), metrics=['cosine_similarity'])  # Specify the loss function and optimizer
...
model2.compile(optimizer=tf.keras.optimizers.AdamW(learning_rate=0.001), loss=custom_loss(distance_matrix), metrics=['cosine_similarity'])  # Specify the loss function and optimizer
